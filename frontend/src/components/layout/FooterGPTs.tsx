...
export default function FooterGPT() {
  let isActive = useAppRoute().subPath === "gpt-store";
  return (
    <footer
      className="bg-white shadow mt-24 ring-zinc-100 ring-1 dark:ring-zinc-300/20 dark:bg-zinc-900 "
    ...
    >
      ...
      <div
        className={`mx-auto ${
          !isActive ? "max-w-screen-2xl" : "max-w-7xl"
        } px-6 py-16 md:px-10 xl:px-20`}
      >
