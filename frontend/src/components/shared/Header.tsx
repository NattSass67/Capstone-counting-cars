...
export function Header() {
  ...
  let isTrackPage = usePathname().includes('tracking')
    ...
    <>
      ...
      >
        <div ref={headerRef} className="top-0 z-10 h-16 pt-6">
          {isSearchPage ? (
            <>
              <div className="z-1 relative top-[140px] h-0 lg:top-[98px]">
                <div className="border-b border-zinc-200 dark:border-zinc-600"></div>
              </div>
            </>
          ) : (
            <Container
